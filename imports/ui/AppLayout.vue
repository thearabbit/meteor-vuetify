<template>
    <v-app top-fixed-toolbar left-fixed-sidebar footer>
        <header>
            <v-toolbar fixed>
                <v-toolbar-side-icon
        ...
        <main>
            <v-sidebar v-model="sidebar" fixed height="100vh">
                <div class="vuetify">
                    <a href="/about" class="sidebar__logo"><img
                            ...
                            height="100" width="100" alt="Vuetify Logo"></a>
                    <div class="title">Rabbit Tech</div>
                    <a href="https://github.com/vuetifyjs/vuetify/releases/tag/v0.11.1" target="_blank">v0.11.1</a>
                </div>
                <hr light="light" class="divider divider--light">
        ...
        <v-footer class="grey darken-2 white--text">
            <div class="copy">
                © 2016
                <a href="http://johnleider.com" target="_blank" class="white--text">John Leider</a>
            </div>
        </v-footer>
    </v-app>
